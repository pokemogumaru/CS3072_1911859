...
public class CS3072_1911859 {
	...
	public static void main(String[] args) throws Exception {
		...
		int iterations = 20000; int NumCities = 5; //number of iterations and number of cities
		int repeats = 21; String type = "HC"; //number of repeats and type of HC to use (HC = basic hill climber) (SA = simulated annealing)
		...
		//NumCities = 15; //repeating with other amount of cities
		MakeTSPsAndPlotWithR(NumCities, true, iterations, repeats, iterations, type, val1,val2, populationSize, false);		
		MakeTSPsAndPlotWithR(NumCities, true, iterations, repeats, iterations, type, val1,val2, populationSize,false);	
