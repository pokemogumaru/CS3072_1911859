...
public class CS3072_1911859 {
	...
	public static void main(String[] args) throws Exception {
		...
		int repeats = 200; String type = "HC"; //number of repeats and type of HC to use (HC = basic hill climber) (SA = simulated annealing)
		double val1 = 10; double val2 = 0.99; int populationSize = 0; //initialTemp & coolingRate used in SA. populationSize ignored in SA. 100-1000 & 0.8-0.99 typical values
